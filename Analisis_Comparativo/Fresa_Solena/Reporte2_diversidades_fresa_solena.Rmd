...
ggsave("DiversidadAlfaFresaKraken.png", plot = last_plot(), width = 30, height = 15, dpi = 300, units = "cm")
```
...
ggsave("DiversidadAlfaFresaKraken_fil.png", plot = last_plot(), width = 30, height = 15, dpi = 300, units = "cm")
```
## Shannon
##
## Simpson
...
ggsave("DiversidadBetaFresaKraken.png", plot = last_plot(), width = 30, height = 15, dpi = 300, units = "cm")
```
```{r}
...
ggsave("DiversidadBetaFresaKraken_fil.png", plot = last_plot(), width = 30, height = 15, dpi = 300, units = "cm")
```
