## GRAFICAS DE PROFUNDIDAD Y NORMALIZACION (edgeR) ELIMINACION DE CEROS
...
percentages_fil_df <- psmelt(percentages_fil)
...
## Metodo de normalizacion (norma de borde)
...
# toma un objeto phyloseq y devuelve un objeto phyloseq cuya tabla otu se transforma.
# edgeRnorm -> Esta función escala datos NGS normalizados utilizando la función de normalización provista en edgeR.
