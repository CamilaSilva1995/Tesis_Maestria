...
La fresa \textit{(Fragaria x ananassa)} es un cultivo de importancia global, reconocido por su valor comercial y nutricional. Su producciòn se enfrenta desafìos significativos ,particularmente relacionados con la suceptibilidad a enfermedades y la influencia de factores ambientales y prácticas agrícolas en la calidad del fruto (). La salud y productividad de la planta de fresa están relacionadas a las interacciones con las comunidades microbianas que las habitan. El microbioma vegetal compuesto por bacterias hongos, y arqueas, se encuentran en en diferentes nichos como elsuelo a granel, la rizosfera(zona del suelo al rededor de las raices) y los tejidos internos de la planta ().  Estas comunidades microbianas desempeñan roles cruciales en la nutrición de la planta, el crecimiento y protección contra patógenos,contibuyendo directamente a su salud ().\\

Comprender cómo la composición y estructura de las comunidades microbianas ayudan a la distinción entre un estado saludable o no saludable de la planta, es fundamental para identificar factores microbianos asociados a un estado saludable y no saludable, y conocer las bases para el desarrollo de estrategias de manejo más sostenibles,como el uso de bio fertilizantes, bioestimulantes o agentes de biocontrol (). La caracterización delmicrobioma de frutos de fresa es particularmente relevante dada su naturaleza y su consumo masivo ().\\

La investigación reciente utilizando enfoques de secuenciación de alto rendimiento ha comenzado a perfilar las comunidades asociadas a la fresa y a explorar su conexion con diferentes nichos. El objetivo principal fue caracterizar las diferencias en la composición y diversidad microbiana de la rizosfera entre plantas infectadas y no infectadas, explorando posibles relaciones entre la infección por oídio y cambios en el microbioma rizosférico.(yang2020comparison) La cual demostro que la infeccion por oídio induce cambios significativos en la estructura y diversidad de lascomunidades bacterianas y fúngicas en el suelo rizosferico de la fresa, observando una reducción general de la riqueza y diversidad. Sugiriendo que la abundancia diferencial de ciertos géneros podría estar relaciobada con la supresión o promoción de la enfermedad.\\
