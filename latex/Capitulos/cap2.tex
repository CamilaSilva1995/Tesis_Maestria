...
En el análisis de diferentes grupos taxonómicos, comenzamos examinando gráficos de barras de abundancias como primer paso para la selección de conjuntos específicos de interés. Al representar las muestras en el eje x y las abundancias en el eje y, se logra una visualización clara de las abundancias, tanto absolutas como relativas, en cada muestra. Este enfoque nos permite identificar de manera eficiente conjuntos particulares que pueden ser esenciales para un análisis más detallado y específico.\\
...
A partir de estos dos subconjuntos, realizamos una agrupación adicional por filo, familia, género y especie. La elección de estos niveles taxonómicos se fundamenta en diferentes propósitos: el filo se selecciona como el siguiente nivel después del reino para proporcionar una visualización panorámica de los datos; mientras que la familia, el género y la especie se eligen para obtener una visualización más detallada y poder identificar diferencias significativas entre los grupos de datos.\\

\textbf{PONER AQUI IMAGEN DE BARRAS DE ABUNDANCIAS RELATIVAS, (filo, familia,genero y especie para eucariota}
%\begin{figure}[!]
%\centering
%\includegraphics[width=\textwidth]{Img/cap2/.png}
%\caption{}
%\end{figure}

\textbf{PONER AQUI IMAGEN DE BARRAS DE ABUNDANCIAS RELATIVAS, (filo, familia,genero y especie para eucariota 10\%}
\begin{figure}[!]
\centering
\includegraphics[width=\textwidth]{Img/cap2/Barras_Eukarya10.png}
\caption{A) Filo, B) Familia, C) Genero, D) Especie, \href{https://github.com/CamilaSilva1995/Tesis_Maestria/blob/main/Analisis_Comparativo/Fresa_Solena/20230227_Funciones&Graficas.R}{(Funciones&Graficas.R)}}
\end{figure}
...
\textbf{PONER AQUI IMAGEN DE BARRAS DE ABUNDANCIAS RELATIVAS, (filo, familia,genero y especie para bacteria}
%\begin{figure}[!]
%\centering
%\includegraphics[width=\textwidth]{Img/cap2/.png}
%\caption{}
...
\textbf{PONER AQUI IMAGEN DE BARRAS DE ABUNDANCIAS RELATIVAS, (filo, familia,genero y especie para bacteria 10\%}
\begin{figure}[!]
\centering
...
\textbf{PONER AQUI IMAGEN DE Diversidades alfa por nivel taxonómico para (filo, familia, genero y especie para eucariota}
\begin{figure}[!]
\centering
...
\textbf{PONER AQUI IMAGEN DE Diversidades alfa por nivel taxonómico (filo, familia, genero y especie para Bacteria}
\begin{figure}[!]
\centering
...
\textbf{PONER AQUI IMAGEN DE Diversidades beta por nivel taxonómico , (filo, familia, genero y especie \textbf{PONER AQUI IMAGEN DE Diversidades beta por nivel taxonómico , (filo, familia,genero y especie para bacteria}}
\begin{figure}[!]
\centering
...
\textbf{PONER AQUI IMAGEN DEDiversidades beta por nivel taxonómico, (filo, familia,genero y especie para bacteria}
\begin{figure}[!]
\centering
