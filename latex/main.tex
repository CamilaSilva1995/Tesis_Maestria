...
\title{Análisis estadístico y computacional de datos metagenómicos: caracterización de la diversidad microbiana del microbioma rizosférico de fresa (Fragaria × ananassa) en función del estado fitosanitario} %Con este nombre se guardará el proyecto en writeLaTex 
...
\bigskip \\
Análisis estadístico y computacional de datos metagenómicos: caracterización de la diversidad microbiana del microbioma rizosférico de fresa (Fragaria × ananassa) en función del estado fitosanitario \\
